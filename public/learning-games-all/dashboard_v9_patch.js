// YSSCHOOL Dashboard V9 patch: lightweight rendering, recommendation labels, teacher defaults.
(function(){
  'use strict';
  if(window.__YS_DASHBOARD_V9__) return; window.__YS_DASHBOARD_V9__=true;
  ...
  safe(()=>{
    document.title='엽쌤스쿨 배움게임월드 100종 대시보드 V9';
    const eyebrow=document.querySelector('.eyebrow'); if(eyebrow) eyebrow.textContent='YSSCHOOL LEARNING GAME WORLD · V9';
    const notice=document.querySelector('.heroBox .notice'); if(notice) notice.innerHTML='<b>V9 적용:</b> 게임 형태는 유지하고 공통 UI를 정리했습니다. 학년은 “추천 학년” 기준으로 고르고, 대시보드는 처음에 일부만 보여 주어 태블릿에서도 가볍게 작동합니다.';
