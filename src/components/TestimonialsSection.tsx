...
const testimonials: Testimonial[] = [
  {
    name: '김○○ 선생님',
    role: '연수 참가 교사',
    content: '에듀테크 활용 연수에서 정말 많은 것을 배웠습니다. 실제 교실에서 바로 적용할 수 있는 실용적인 내용이 가득했어요!',
    rating: 5,
  },
  {
    name: '이○○ 선생님',
    role: '동료 교사',
    content: '엽쌤의 수업 혁신 사례는 정말 인상적입니다. 아이들의 눈높이에 맞춘 창의적인 교육 방법에 항상 감탄합니다.',
    rating: 5,
  },
  {
    name: '박○○ 학부모',
    role: '학부모',
    content: '아이가 학교에서 만든 책을 자랑스럽게 가져왔을 때 정말 감동이었습니다. 선생님 덕분에 독서를 좋아하게 되었어요.',
    rating: 5,
  },
  {
    name: '최○○ 선생님',
    role: 'KENTEC 연수생',
    content: 'AI 활용 교육 연수가 매우 체계적이고 실용적이었습니다. 직접 만든 웹앱들도 인상 깊었습니다.',
    rating: 5,
  },
];
