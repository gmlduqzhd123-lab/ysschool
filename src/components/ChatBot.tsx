...
const faqData = [
  ...
  },
  {
    ...
    answer: '엽쌤의 도서는 YES24에서 구매할 수 있습니다! "고학년 독서인문교육, 독서미션으로 끝장내기" 등 10권 이상의 도서가 있습니다. 📚\n\n📖 저서 목록 보기 → /portfolio#publications',
  },
  {
  ...
  },
  {
    ...
    answer: '엽쌤이 직접 개발한 웹앱들은 에듀테크 갤러리에서 확인할 수 있습니다! 교실에서 바로 사용할 수 있는 다양한 도구들이 있어요. 💻\n\n🎮 에듀테크 갤러리 → /showcase',
  },
  {
  ...
  },
  {
    ...
    answer: '엽쌤스쿨 배움게임월드에서 100개의 HTML 학습 게임을 즐겨보세요! 국어, 수학, 과학 등 다양한 과목을 게임으로 배울 수 있어요. 🎮\n\n🎮 에듀테크 갤러리 → /showcase',
  },
  {
    keywords: ['수상', '상', '표창'],
