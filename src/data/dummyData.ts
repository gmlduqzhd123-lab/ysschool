...
export const eduResourcesData = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1516280440502-a7f457116f1c?auto=format&fit=crop&q=80&w=800',
...
export const webAppsData = [
  {
    id: 1,
    title: '[언론보도] 전남창의융합인재양성 성과 공유',
    description: '여수발명교육센터에서 진행한 전남창의융합인재양성프로젝트의 우수한 성과를 나누고, 창의력 챔피언 대회를 지도한 엽쌤의 교육 활동이 소개되었습니다.',
    image: 'https://images.unsplash.com/photo-1511629091441-ee46146481b6?auto=format&fit=crop&q=80&w=1200',
    techStack: ['창의융합인재', '발명영재교육', '언론보도'],
    link: 'https://www.ihopenews.com/news/articleView.html?idxno=227910',
  },
  {
    id: 2,
    title: '[언론보도] 예스24 어린이 독후감 대회 우수 지도교사',
    description: '나도 작가 프로젝트 등 학생 저자 육성에 힘쓴 결과, YES24 어린이 독후감 대회에서 전국 단위 우수 지도교사상 및 다수의 입상자를 배출했습니다.',
    image: 'https://image.yes24.com/images/chyes24/b/a/d/a/bada6de10e8c9403ed87d4f101f832cc.jpg',
    techStack: ['YES24', '독후감대회', '학생저자'],
    link: 'https://ch.yes24.com/Article/Details/51895',
  },
  {
    id: 3,
    title: '[언론보도] 전남 여수교육지원청, 디지털 수업역량 연수',
    description: 'AI 중점학교 및 디지털 선도학교 주무로서, 교사들의 에듀테크 활용 능력과 AI 기반 수업 역량을 강화하기 위한 연수를 성공적으로 운영했습니다.',
    image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=1200',
    techStack: ['에듀테크', '디지털선도', '언론보도'],
    link: 'https://www.jnedu.kr/news/articleView.html?idxno=100963',
  },
];
